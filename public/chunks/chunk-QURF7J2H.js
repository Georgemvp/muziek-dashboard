import{c as M,i as D,j as E}from"./chunk-PMVWGOAV.js";import{l as P,p as S}from"./chunk-VZVFHTNV.js";import{B as m,C as p,E as w,F as f,a as v,e as A,f as I,g as y,h,i as $,j as i,l as x,m as k,p as T,q as L,t as H}from"./chunk-XF3BALWA.js";var b=null;function j(){b&&(clearInterval(b),b=null)}async function tt(){let e=document.getElementById("plex-np-wrap");if(e)try{let n=await fetch("/api/plex/nowplaying").then(t=>t.json());if(!e.isConnected)return;e.innerHTML=n.playing?`<div class="plex-np"><div class="plex-np-dot"></div><span class="plex-np-label">PLEX NU</span>
