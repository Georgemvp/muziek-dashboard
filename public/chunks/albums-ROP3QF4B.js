import{i as z,n as y}from"./chunk-ODXHRBJF.js";import{a as A}from"./chunk-XRQN57E4.js";import{d as S,f as v,g as _,h as n,j as w,x as $}from"./chunk-OJFTIB2W.js";import"./chunk-2BMKGNH5.js";var b=null,g=null,h="",m="artist",d="grid",x=null,C=0,D=210,H=3;function f(){return document.getElementById("content")}function B(){let t=window.innerWidth;return t>=1600?8:t>=1300?7:t>=1050?6:t>=850?5:t>=650?4:t>=480?3:2}function I(t){if(!t)return"-";let e=Math.floor(t/60),a=t%60;return`${e}:${a.toString().padStart(2,"0")}`}async function K(t){x=t;let e=f();if(!e)return;C=e.scrollTop||0,await q()}function P(){x=null;let t=f();if(t){let e=L(b||[]);t.innerHTML=`
    ...
    `;let a=t.querySelector("#albums-container");a&&T(a,e).then(()=>{setTimeout(()=>{t.scrollTop=C},0)})}}async function q(){let t=f();if(!t||!x)return;let e=x,a=e.thumb?S(e.thumb,320):null,l=z(),s=[];try{let i=await $(`/api/plex/album/${e.ratingKey}/tracks`);i&&Array.isArray(i.tracks)&&(s=i.tracks)}catch(i){console.error("Error loading album tracks:",i)}let r=s.length?`<div class="album-detail-tracks">
         ...
         <div class="album-detail-tracklist">
           ${s.map((i,o)=>`
             <div class="album-track" data-rating-key="${n(i.ratingKey)}">
               <div class="album-track-num">${o+1}</div>
               <div class="album-track-title">${n(i.title)}</div>
    ...
    <div class="album-detail-view">
      ...
      <div class="album-detail-hero">
        <div class="album-detail-cover-wrapper">
          ${a?`<img src="${n(a)}" alt="${n(e.album)}" class="album-detail-cover" loading="lazy" decoding="async">`:`<div class="album-detail-cover-ph" style="background:${w(e.album)}">${v(e.album)}</div>`}
        </div>
  ...
  `,Z(e,s)}function Z(t,e){let a=f();if(!a)return;a.querySelectorAll(".album-track").forEach(i=>{i.addEventListener("mouseenter",()=>{let o=i.querySelector(".album-track-num"),c=i.querySelector(".album-track-play");o&&(o.style.opacity="0"),c&&(c.style.opacity="1")}),i.addEventListener("mouseleave",()=>{let o=i.querySelector(".album-track-num"),c=i.querySelector(".album-track-play");o&&(o.style.opacity="1"),c&&(c.style.opacity="0")})});let s=a.querySelector(".album-detail-play-btn"),r=a.querySelector(".album-detail-plex-btn");s&&s.addEventListener("click",async()=>{await y(t.ratingKey,"music")}),r&&r.addEventListener("click",async()=>{await y(t.ratingKey,"music")})}function L(t){let e=t;if(h.trim()){let l=h.toLowerCase();e=e.filter(s=>s.artist.toLowerCase().includes(l)||s.album.toLowerCase().includes(l))}let a=[...e];switch(m){case"artist-za":a.sort((l,s)=>{let r=s.artist.localeCompare(l.artist);return r!==0?r:s.album.localeCompare(l.album)});break;case"album":a.sort((l,s)=>l.album.localeCompare(s.album));break;case"album-za":a.sort((l,s)=>s.album.localeCompare(l.album));break;case"recent":a.sort((l,s)=>(s.addedAt||0)-(l.addedAt||0));break;case"artist":default:a.sort((l,s)=>{let r=l.artist.localeCompare(s.artist);return r!==0?r:l.album.localeCompare(s.album)});break}return a}async function F(){if(b)return b;try{let t=await $("/api/plex/library/all");if(!t||!t.library)return console.warn("Albums API response is null/undefined:",t),[];if(!Array.isArray(t.library))return console.warn("Library is not an array:",t.library),[];if(!t.library.length)return[];let e=t.library.map(([l,s,r,i,o])=>({artist:l||"",album:s||"",ratingKey:r||"",thumb:i||"",addedAt:o||0,playcount:0})),a={};try{let l=await $("/api/core/top/albums?period=overall");l?.topalbums?.album&&l.topalbums.album.forEach(s=>{let r=`${(s.artist||"").toLowerCase()}|${(s.name||"").toLowerCase()}`;a[r]={playcount:s.playcount||0}})}catch(l){console.warn("Error loading Last.fm albums:",l)}return b=e.map(l=>{let s=`${l.artist.toLowerCase()}|${l.album.toLowerCase()}`,r=a[s];return{...l,playcount:r?.playcount||0}}),b}catch(t){return console.error("Error loading albums:",t),[]}}function V(t){let e=new Map;for(let a of t){let l=(a.artist[0]||"#").toUpperCase(),s=/[A-Z]/.test(l)?l:"#";e.has(s)||e.set(s,[]),e.get(s).push(a)}return e}function G(t){let e=t.thumb?S(t.thumb,240):null,a=e?`<img src="${n(e)}" alt="${n(t.album)} by ${n(t.artist)}" loading="lazy" decoding="async"
  ...
  `,U()}function U(){document.getElementById("albums-search")?.addEventListener("input",t=>{h=t.target.value,E()}),document.getElementById("albums-btn-grid")?.addEventListener("click",()=>{d!=="grid"&&(d="grid",k(),E())}),document.getElementById("albums-btn-list")?.addEventListener("click",()=>{d!=="list"&&(d="list",k(),E())}),document.getElementById("albums-sort-select")?.addEventListener("change",t=>{m=t.target.value,k(),E()})}function E(){let t=document.getElementById("albums-container");if(t){let e=L(b||[]);T(t,e)}}async function T(t,e){g&&(g.destroy(),g=null);let a=e||L(b||[]);if(O(a.length),!a.length){t.innerHTML=`
      ...
      </div>`;return}g=new R(t,a),N(g)}async function tt(t){let e=t.target.closest(".albums-artist-btn");if(e){t.stopPropagation();let o=e.closest(".albums-album")?.dataset.artist||e.title;return o&&A("artist-detail",{name:o}),!0}let a=t.target.closest(".albums-album");if(a&&!t.target.closest(".albums-play-btn")&&!t.target.closest(".albums-artist-btn")){let i={ratingKey:a.dataset.ratingKey,album:a.dataset.album,artist:a.dataset.artist,thumb:a.dataset.thumb};return await K(i),!0}let l=t.target.closest(".albums-play-btn");if(l){let i=l.closest(".albums-album");if(i){t.stopPropagation();let o=i.dataset.ratingKey;try{await y(o,"music")}catch(c){console.error("Error playing album:",c)}}return!0}if(t.target.closest(".album-detail-back"))return P(),!0;let s=t.target.closest(".album-detail-artist-link");if(s){let i=s.dataset.artist;return i&&A("artist-detail",{name:i}),!0}let r=t.target.closest(".album-track-play");if(r){let i=r.closest(".album-track");if(i){t.stopPropagation();let o=i.dataset.ratingKey;try{await y(o,"music")}catch(c){console.error("Error playing track:",c)}}return!0}return!1}async function et(){let t=f();if(!t)return;document.title="Muziek \xB7 Albums";let e=await F();if(k(),t.innerHTML=`
    <div style="display: flex; gap: 8px; flex: 1;">
      <div style="flex: 1;" id="albums-container"></div>
      <div id="albums-az-rail" class="albums-az-rail"></div>
    </div>
