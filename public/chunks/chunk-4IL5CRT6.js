import{i as H,o as S,p as E}from"./chunk-L7FPKZB5.js";import{p as M,t as D}from"./chunk-O5JU5Q5K.js";import{c as A,d as I,e as y,f as h,g as $,h as a,i as x,j as k,m as T,n as L,q as P,v as g,w as p,y as w,z as f}from"./chunk-HCN2ZK5I.js";import{a as v}from"./chunk-2BMKGNH5.js";var b=null;function j(){b&&(clearInterval(b),b=null)}async function te(){let s=document.getElementById("plex-np-wrap");if(s)try{let n=await fetch("/api/plex/nowplaying").then(e=>e.json());if(!s.isConnected)return;s.innerHTML=n.playing?`<div class="plex-np"><div class="plex-np-dot"></div><span class="plex-np-label">PLEX NU</span>
