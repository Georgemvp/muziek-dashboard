import{i as H,o as S,p as E}from"./chunk-HHAPXIOM.js";import{p as M,t as D}from"./chunk-OFQL44M6.js";import{c as A,d as I,e as y,f as h,g as $,h as a,i as x,j as k,m as T,n as L,q as P,v as g,w as p,y as w,z as f}from"./chunk-7DIT565V.js";import{a as v}from"./chunk-7DVASGHB.js";var b=null;function j(){b&&(clearInterval(b),b=null)}async function te(){let s=document.getElementById("plex-np-wrap"),n=null;try{n=await fetch("/api/plex/nowplaying").then(e=>e.json()),s?.isConnected&&(s.innerHTML=n.playing?`<div class="plex-np"><div class="plex-np-dot"></div><span class="plex-np-label">PLEX NU</span>
