import{A as I,B,C as P,D as J,E as $,X as W,a as t,b as M,e as S,f as E,h as u,i as R,j as o,m as b,n as q,o as T,p as F,q as G,s as C,u as U,v as h,w as A,x as D,y as z,z as L}from"./chunk-MZ4NN5XF.js";async function be(){try{let l=await $("/api/spotify/status");t.spotifyEnabled=!!l.enabled;let e=document.getElementById("tb-mood");t.spotifyEnabled&&t.activeView==="ontdek"?(e.style.display="",e.classList.add("visible")):t.spotifyEnabled&&(e.style.display="")}catch{t.spotifyEnabled=!1}}function te(l,e){let s=l.image?`<img src="${o(l.image)}" alt="" loading="lazy"
