import{p as W}from"./chunk-VZVFHTNV.js";import{A as L,B as I,C as B,D as P,E as J,F as $,a as t,b as M,e as S,f as E,h as u,i as R,j as o,m as b,n as q,o as T,p as F,q as G,t as C,v as U,w as h,x as A,y as D,z}from"./chunk-XF3BALWA.js";async function be(){try{let l=await $("/api/spotify/status");t.spotifyEnabled=!!l.enabled;let e=document.getElementById("tb-mood");t.spotifyEnabled&&t.activeView==="ontdek"?(e.style.display="",e.classList.add("visible")):t.spotifyEnabled&&(e.style.display="")}catch{t.spotifyEnabled=!1}}function te(l,e){let s=l.image?`<img src="${o(l.image)}" alt="" loading="lazy"
