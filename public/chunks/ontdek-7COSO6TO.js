import{p as W}from"./chunk-4Q7IW62X.js";import{A as L,B as I,C as B,D as P,E as J,F as $,a as t,b as M,e as S,f as E,h as u,i as R,j as o,m as b,n as q,o as T,p as F,q as G,t as C,v as U,w as h,x as A,y as D,z}from"./chunk-OXJVLDHB.js";async function be(){try{let l=await $("/api/spotify/status");t.spotifyEnabled=!!l.enabled;let e=document.getElementById("tb-mood");t.spotifyEnabled&&t.activeView==="ontdek"?(e.style.display="",e.classList.add("visible")):t.spotifyEnabled&&(e.style.display="")}catch{t.spotifyEnabled=!1}}function te(l,e){let s=l.image?`<img src="${o(l.image)}" alt="" loading="lazy"
      ...
      <div class="section-block" data-section="discover">
        ...
        <div class="section-content" id="sec-discover-content">
          <div class="loading"><div class="spinner"></div>Laden...</div>
            ...
            </div>`:`<div class="collapsed-thumb collapsed-thumb-round" style="background:${b(m.name)}"><span class="collapsed-thumb-ph">${u(m.name)}</span></div>`).join("")}${s.length>8?`<span class="collapsed-thumbs-more">+${s.length-8}</span>`:""}</div>`;let c=document.getElementById("hdr-title-discover");c&&(c.textContent=`\u{1F52D} Ontdek Artiesten \xB7 ${s.length} artiesten`)}}catch{}})(),z(document.getElementById("sec-discover-content"),()=>{let e=document.getElementById("sec-discover-content");return L(e,j)}),O("recs","recs"),O("releases","releases"),O("discover","discover")}export{se as applyRecsFilter,be as checkSpotifyStatus,N as clearSpotifyRecs,ne as loadCollapsibleState,j as loadDiscover,re as loadOntdek,Y as loadRecs,H as loadReleases,X as loadSpotifyRecs,le as relativeDate,ie as renderDiscover,ae as renderReleases,oe as saveCollapsibleState,O as setupSectionToggle,te as spotifyCard,Z as updateReleasesBadge,Q as updateToggleButtonState};
