import{j as H,p as S,q as E}from"./chunk-XZOAJ3LG.js";import{l as M,p as D}from"./chunk-2E4OGBCT.js";import{A as p,C as w,D as f,a as v,d as A,e as I,f as y,g as h,h as $,i as a,k as x,l as k,o as T,p as L,s as P,z as g}from"./chunk-XOZD6SLL.js";var b=null;function j(){b&&(clearInterval(b),b=null)}async function te(){let s=document.getElementById("plex-np-wrap");if(s)try{let n=await fetch("/api/plex/nowplaying").then(e=>e.json());if(!s.isConnected)return;s.innerHTML=n.playing?`<div class="plex-np"><div class="plex-np-dot"></div><span class="plex-np-label">PLEX NU</span>
