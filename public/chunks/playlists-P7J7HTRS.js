import{a as h}from"./chunk-EDJKRVG3.js";import{A as v,a as c,e as u,h as g,i as t}from"./chunk-LCSFBDUL.js";function f(i){if(!i)return"\u2014";let l=Math.floor(i/1e3),e=Math.floor(l/60),d=l%60;return`${e}:${d.toString().padStart(2,"0")}`}function $(i){return i?`${Math.round(i/6e4)} min`:""}async function T(){let i=document.getElementById("content");if(i){i.innerHTML=`
