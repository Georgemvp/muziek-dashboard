import{i as H,o as S,p as E}from"./chunk-HWK6RXVG.js";import{p as M,t as D}from"./chunk-22OPLRLQ.js";import{c as A,d as I,e as y,f as h,g as $,h as a,i as x,j as k,m as T,n as L,q as P,v as g,w as p,y as w,z as f}from"./chunk-FUEEWMYC.js";import{a as v}from"./chunk-GRRN6U7X.js";var b=null;function j(){b&&(clearInterval(b),b=null)}async function te(){let s=document.getElementById("plex-np-wrap"),n=null;try{n=await fetch("/api/plex/nowplaying").then(e=>e.json()),s?.isConnected&&(s.innerHTML=n.playing?`<div class="plex-np"><div class="plex-np-dot"></div><span class="plex-np-label">PLEX NU</span>
