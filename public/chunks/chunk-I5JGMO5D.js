import{i as H,o as S,p as E}from"./chunk-DNLDPMEE.js";import{l as M,p as D}from"./chunk-NE65XLZW.js";import{A as f,a as v,d as A,e as I,f as y,g as h,h as $,i as a,j as x,k,n as T,o as L,r as P,w as g,x as p,z as w}from"./chunk-G2KURTNZ.js";var b=null;function j(){b&&(clearInterval(b),b=null)}async function te(){let s=document.getElementById("plex-np-wrap");if(s)try{let n=await fetch("/api/plex/nowplaying").then(e=>e.json());if(!s.isConnected)return;s.innerHTML=n.playing?`<div class="plex-np"><div class="plex-np-dot"></div><span class="plex-np-label">PLEX NU</span>
