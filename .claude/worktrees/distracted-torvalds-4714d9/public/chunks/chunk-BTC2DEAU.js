import{a as b}from"./chunk-OBIGRC7P.js";import{E as m,F as f,h as d,z as c}from"./chunk-HCN2ZK5I.js";import{a as o}from"./chunk-2BMKGNH5.js";var p=document.querySelector(".app-shell"),M=document.getElementById("sidebar"),y=document.getElementById("sidebar-toggle");function S(){let e=document.getElementById("sidebar-overlay");return e||(e=document.createElement("button"),e.id="sidebar-overlay",e.className="sidebar-overlay",e.setAttribute("aria-label","Sluit zijbalk"),document.body.appendChild(e),e)}var h=S();function r(e){p&&(p.classList.toggle("sidebar-open",e),y?.setAttribute("aria-expanded",e?"true":"false"),h.classList.toggle("visible",e))}function C(){r(!1),y?.addEventListener("click",()=>{let e=p?.classList.contains("sidebar-open");r(!e)}),h.addEventListener("click",()=>r(!1)),document.querySelectorAll(".nav-item[data-view]").forEach(e=>{e.addEventListener("click",()=>r(!1))}),document.addEventListener("sidebar:close",()=>r(!1)),document.querySelectorAll(".sidebar-collapse-toggle").forEach(e=>{let s=e.getAttribute("aria-controls");localStorage.getItem(`sidebar-group-${s}`)==="open"&&e.setAttribute("aria-expanded","true"),e.addEventListener("click",t=>{t.stopPropagation();let a=e.getAttribute("aria-expanded")==="true";e.setAttribute("aria-expanded",a?"false":"true"),localStorage.setItem(`sidebar-group-${s}`,a?"closed":"open")})}),x(),$().catch(e=>{console.error("Failed to load sidebar playlists:",e)})}var L=[{id:"all",label:"All",color:"#888"},{id:"tidal",label:"Tidal",color:"#33ffe7"},{id:"qobuz",label:"Qobuz",color:"#0070ef"},{id:"deezer",label:"Deezer",color:"#a238ff"},{id:"spotify",label:"Spotify",color:"#1cc659"},{id:"soundcloud",label:"SoundCloud",color:"#ff5502"},{id:"applemusic",label:"Apple Music",color:"#FA586A"},{id:"beatport",label:"Beatport",color:"#00ff89"},{id:"beatsource",label:"Beatsource",color:"#16a8f4"},{id:"youtube",label:"YouTube",color:"#FF0000"}];function x(){let e=document.getElementById("sidebar");if(!e)return;let s=localStorage.getItem("downloadEngine")||"tidarr",l=localStorage.getItem("orpheusPlatform")||"all";o.downloadEngine=s,o.orpheusPlatform=l;let t=document.createElement("div");t.className="sidebar-settings-panel",t.id="sidebar-settings-panel",t.setAttribute("aria-hidden","true"),t.innerHTML=`
