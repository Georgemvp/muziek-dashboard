import{a as L}from"./chunk-OBIGRC7P.js";import{E,F as S,h as u,z as m}from"./chunk-HCN2ZK5I.js";import{a as p}from"./chunk-2BMKGNH5.js";var h=document.querySelector(".app-shell"),z=document.getElementById("sidebar"),A=document.getElementById("sidebar-toggle");function B(){let e=document.getElementById("sidebar-overlay");return e||(e=document.createElement("button"),e.id="sidebar-overlay",e.className="sidebar-overlay",e.setAttribute("aria-label","Sluit zijbalk"),document.body.appendChild(e),e)}var $=B();function f(e){h&&(h.classList.toggle("sidebar-open",e),A?.setAttribute("aria-expanded",e?"true":"false"),$.classList.toggle("visible",e))}function N(){f(!1),A?.addEventListener("click",()=>{let e=h?.classList.contains("sidebar-open");f(!e)}),$.addEventListener("click",()=>f(!1)),document.querySelectorAll(".nav-item[data-view]").forEach(e=>{e.addEventListener("click",()=>f(!1))}),document.addEventListener("sidebar:close",()=>f(!1)),document.querySelectorAll(".sidebar-collapse-toggle").forEach(e=>{let t=e.getAttribute("aria-controls");localStorage.getItem(`sidebar-group-${t}`)==="open"&&e.setAttribute("aria-expanded","true"),e.addEventListener("click",s=>{s.stopPropagation();let l=e.getAttribute("aria-expanded")==="true";e.setAttribute("aria-expanded",l?"false":"true"),localStorage.setItem(`sidebar-group-${t}`,l?"closed":"open")})}),O(),_().catch(e=>{console.error("Failed to load sidebar playlists:",e)})}var T=[{id:"all",label:"All",color:"#888"},{id:"tidal",label:"Tidal",color:"#33ffe7"},{id:"qobuz",label:"Qobuz",color:"#0070ef"},{id:"deezer",label:"Deezer",color:"#a238ff"},{id:"spotify",label:"Spotify",color:"#1cc659"},{id:"soundcloud",label:"SoundCloud",color:"#ff5502"},{id:"applemusic",label:"Apple Music",color:"#FA586A"},{id:"beatport",label:"Beatport",color:"#00ff89"},{id:"beatsource",label:"Beatsource",color:"#16a8f4"},{id:"youtube",label:"YouTube",color:"#FF0000"}];function O(){let e=document.getElementById("sidebar");if(!e)return;let t=localStorage.getItem("downloadEngine")||"tidarr",i=localStorage.getItem("orpheusPlatform")||"all";p.downloadEngine=t,p.orpheusPlatform=i;let s=document.createElement("div");s.className="sidebar-settings-panel",s.id="sidebar-settings-panel",s.setAttribute("aria-hidden","true"),s.innerHTML=`
