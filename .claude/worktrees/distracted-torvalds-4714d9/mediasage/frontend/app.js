...
async function apiCall(endpoint, options = {}) {
    const response = await fetch(`/mediasage/api${endpoint}`, {
        headers: {
...
function generatePlaylistStream(request, onProgress, onComplete, onError) {
    ...
    fetch('/mediasage/api/generate/stream', {
        method: 'POST',
...
function finalizeHistoryDelete(resultId) {
    ...
    fetch(`/mediasage/api/results/${encodeURIComponent(resultId)}`, { method: 'DELETE' })
        .then(resp => {
...
async function updateFilterPreview() {
    ...
    try {
        ...
        const response = await fetch('/mediasage/api/filter/preview', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
...
async function updateRecAlbumPreview() {
    ...
    try {
        ...
        const response = await fetch(`/mediasage/api/recommend/albums/preview?${params}`, {
...
async function handleRecGenerate() {
    ...
    try {
        const response = await fetch('/mediasage/api/recommend/generate', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
