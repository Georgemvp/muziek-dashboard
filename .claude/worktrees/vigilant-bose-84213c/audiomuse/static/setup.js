var serverFields = {
    ...
    plex: [
        {name: 'PLEX_URL', label: 'Plex URL', placeholder: 'http://your-plex-server:32400', tooltip: 'Base URL of your Plex Media Server, including http:// or https:// and the port. Must be reachable from the AudioMuse-AI container.'},
        {name: 'PLEX_TOKEN', label: 'Plex token', placeholder: 'your-plex-token', tooltip: 'X-Plex-Token for authentication. Find it in the Plex web UI by inspecting any API request, or check the Plex preferences XML file.'}
    ]
};
